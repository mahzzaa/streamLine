	...
	>
		<ul class="list-disc">
			...
			{#each todos as { id, title, completed } (id)}
				...
				<li class="flex items-center justify-between">
					<label class="flex items-center justify-center mr-4 space-x-3">
						<input
							class="w-5 h-5 bg-transparent border-2 rounded-md hover:border-0 hover:variant-ghost-secondary hover:cursor-pointer"
							type="checkbox"
							checked={completed}
						/>
						<p class="text-lg">
					...
					>
						<svg
							class="w-5 h-5 pb-0 mb-0 hover:fill-error-600"
							fill="#fff"
							version="1.1"
							id="Layer_1"
		...
		>
			<input
				...
				class="p-2 rounded-lg hover:variant-ghost-secondary placeholder:text-primary-300 text-primary-700 variant-ghost-primary hover:cursor-pointer focus:cursor-text"
				type="text"
			/>
